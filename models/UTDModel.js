...
export const get = (req, callback) => {
    ...
    const sqlFrom = 'FROM ' +
        ...
        'LEFT JOIN dbfaskes.satu_sehat ON dbfaskes.data_utd.id_faskes = dbfaskes.satu_sehat.id_faskes ' +
        'LEFT JOIN dbfaskes.penanggung_jawab_faskes ON dbfaskes.data_utd.id_faskes = dbfaskes.penanggung_jawab_faskes.id_faskes ' +
