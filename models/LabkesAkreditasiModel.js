...
export const getSertifikasiLabkes = (req, callback) => {
    ...
    const sqlWhere = 'WHERE dbfaskes.registrasi_user.id_kategori = 7 ' + 
...
export const getLabkesAkreditasi = (req, callback) => {
    ...
    const sqlSelect = 'SELECT dbfaskes.trans_final.kode_faskes_baru as kode_faskes, '+
