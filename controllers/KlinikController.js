import { get, show } from "../models/KlinikModel.js";
import paginationDB from "../config/PaginationDB.js";
import Joi from "joi";

export const getKlinik = (req, res) => {
      ...
      if (!acc[key]) {
        if (req.user.level_id == 2) {
          acc[key] = {
            ...
            namaPenanggungJawabKlinik: curr.namaPenanggungJawabKlinik,
            jenisModalUsaha: curr.jenisModalUsaha,
            jenisKlinik: curr.jenisKlinik,
            jenisPerawatan: curr.jenisPerawatan,
            alamat: curr.alamat,
            noTelp: curr.noTelp,
            email: curr.email,
...
export const showKlinik = (req, res) => {
