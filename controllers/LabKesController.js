import { get, show } from "../models/LabKesModel.js";
import paginationDB from "../config/PaginationDB.js";
import Joi from "joi";

export const getLabKes = (req, res) => {
            ...
            if (!acc[key]) {
                if (req.user.level_id == 2) {
                    acc[key] = {
                        idBaru: curr.idBaru,
                        nama: curr.nama,
                        jenisPelayanan: curr.jenisPelayanan,
                        jenisLab: curr.jenisLab,
                        labMedisKhusus: curr.labMedisKhusus,
                        pelayananLain: curr.pelayananLain,
                        bentukPelayanan: curr.bentukPelayanan,
                        bentukLab: curr.bentukLab,

                        namaFasyankesTerintegrasi: curr.namaFasyankesTerintegrasi,
                        statusAkreditasi: curr.statusAkreditasi,
                        rumahSakitYangBekerjaSama: curr.rumahSakitYangBekerjaSama,
                        statusLabkes: curr.statusLabkes,
                        pemilik: curr.pemilik,
                        namaPemilik: curr.namaPemilik,
                        ...
                        idPersetujuanKetentuanAPISatSet:
                            curr.idPersetujuanKetentuanAPISatSet,
...
export const showLabKes = (req, res) => {
